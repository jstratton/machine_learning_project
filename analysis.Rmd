...
# Abstract
I created a random forest model to detect common weight lifting errors. 54 variables were used to categorize weight lifting data into 5 categories. 4 of the categories corresponded to poor weight lifting techniques with the remaining category corresponding to proper weight lifting technique. More information about each category can be found at http://groupware.les.inf.puc-rio.br/har. Model accuracy consistently achieved 99% accuracy during k-fold cross-validation.
