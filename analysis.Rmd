...
# Set train to use k-fold cross validation, with k = 10
...
x <- training[,-length(training$classe)]
y <- training[,length(training$classe)]
exercise_model <- train(classe ~ ., data = training, method = "rf", preProcess = "pca")
```
